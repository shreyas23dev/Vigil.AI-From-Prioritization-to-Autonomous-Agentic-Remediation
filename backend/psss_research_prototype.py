# -*- coding: utf-8 -*-
"""psss research - prototype

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1FpFX0KKOmEt4-bpXiRUkmJLKa-RYHCbP
"""
...
print("✅ Cleaned datasets saved as CSV")
...
print("✅ Predicted CVSS vectors for unlabeled CVEs")
...
print("✅ Added CVSS_base_pred column")
df_unlabeled.head(10)
...
print("✅ Master dataset created with no missing CVSS values")
...
print("✅ Merged EPSS scores into master dataset")
df_merged.head(10)
...
print("✅ Added ATT&CK techniques to dataset")
display(df_attack[["cve_id","CVSS_base_final","epss","techniques","Phase"]].head(10))

# Define critical techniques → tactics
critical_techniques = {
...
print("✅ Added attack_criticality flag")
...
print("✅ Final PSSS with ATT&CK context computed & saved")
...
bars1 = ax.bar(index, top_cves["PSSS_before"], bar_width, label="PSSS (before ATT&CK)", color="skyblue")
bars2 = ax.bar([i + bar_width for i in index], top_cves["PSSS_final"], bar_width, label="PSSS_final (with ATT&CK)", color="salmon")
...
# ==========================================
# Adaptive Weighting via Logistic Regression
# ==========================================
from sklearn.linear_model import LogisticRegression
from sklearn.preprocessing import StandardScaler
from sklearn.pipeline import make_pipeline

# Create proxy labels if no ground truth: EPSS > 0.5 => exploited
if "exploited_in_wild" not in df_attack.columns:
    df_attack["exploited_in_wild"] = (df_attack["epss"].fillna(0) > 0.5).astype(int)

# Features: normalized CVSS, EPSS, attack_criticality
X = df_attack[["CVSS_base_final", "epss", "attack_criticality"]].fillna(0)
y = df_attack["exploited_in_wild"]

# Logistic Regression pipeline
logreg_model = make_pipeline(StandardScaler(), LogisticRegression(max_iter=1000))
logreg_model.fit(X, y)

weights = logreg_model.named_steps["logisticregression"].coef_[0]
alpha, beta, gamma = weights / (abs(weights).sum() + 1e-8)

print(f"Adaptive weights learned: alpha={alpha:.3f}, beta={beta:.3f}, gamma={gamma:.3f}")

# Compute adaptive PSSS
df_attack["PSSS_adaptive"] = (
    alpha * df_attack["CVSS_base_final"].fillna(0) +
    beta * df_attack["epss"].fillna(0) +
    gamma * df_attack["attack_criticality"].fillna(0)
)

print("✅ Adaptive PSSS computed and added to dataset")